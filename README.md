...
-   **API Implementation**
    ...
    -   I updated the `POST /expenses/:id` endpoint to also accept a change to category. Now user can set a category on an expense and then filter by those categories.
...
-   **Functionalities I'm most proud of:**
    ...
    -   I enjoyed creating the expense-filters
